...
begin;
-- set @buyDrugUrl = 'https://m.hsyuntai.com/e/310000/prescription_qrorder?pscriptIds=[%s]&source=sms';  -- 预发
set @buyDrugUrl = 'https://m.hsyuntai.com/cloud/310000/prescription_qrorder?pscriptIds=[%s]&source=sms'; --生产

delete from cfg_prd_param
     where prd_type= 'DCT' and prd_code='DCT-000001' and param_code='PAT_SMS_BUY_DRUG_URL';

insert into cfg_prd_param(param_id, prd_type,prd_code,param_code,param_name,param_value,is_deleted)
  values(uuid(),'DCT','DCT-000001','PAT_SMS_BUY_DRUG_URL','短信购药连接',@buyDrugUrl,'N');
commit;
