...
public class DefaultNettyContext implements NettyContext {
    ...
    private DefaultNettyContext()
    {
        ...
        {
            _bossEventLoopGroup = new EpollEventLoopGroup(0,new DefaultThreadFactory("HdpClientBoss"));
            _workerEventLoopGroup = new EpollEventLoopGroup(0,new DefaultThreadFactory("HdpClientWorker"));
        ...
        {
            _bossEventLoopGroup = new NioEventLoopGroup(0,new DefaultThreadFactory("HdpClientBoss"));
            _workerEventLoopGroup = new NioEventLoopGroup(0,new DefaultThreadFactory("HdpClientWorker"));
